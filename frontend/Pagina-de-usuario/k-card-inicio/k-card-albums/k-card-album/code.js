...
async function getalbum() {
  try {
    ...
    //Esto es para cambiar la ruta de las imagenes para adaptarlas a pagina de usuario
    const imgPath = album.imagen;
    const fileName = imgPath.split("/").pop();
    if (imgPath == "../../images/resources/no-img.jpeg") {
      imgAlbum.src =
        "../../../../Pagina-de-Administrador/k-card-inicio/images/resources/" +
        fileName;
    } else {
      imgAlbum.src =
        "../../../../Pagina-de-Administrador/k-card-inicio/images/albums/" +
        fileName;
    }
    ...
    associatedPhotocards.forEach((photocard) => {
      ...
      buttonVer.href =
        "../../k-card-photocards/k-card-photocard/index.html?id=" +
        photocard.id;
