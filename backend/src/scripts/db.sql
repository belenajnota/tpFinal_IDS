...
CREATE TABLE photocards (
    ...
    album REFERENCES albums(id) ON DELETE CASCADE
);
...
INSERT INTO ventas 
(nombre_cliente, telefono_cliente, instagram_cliente, precio_venta, medio_de_pago, fecha_venta, lugar_entrega, fecha_entrega, hora_entrega, costo_entrega, id_photocard)
VALUES
('Camila Rodríguez', '1123456789', 'cm.kpop', 6000, 'Mercado Pago', '2025-07-03', 'Av. Rivadavia 4623', '2025-07-05', '15:00:00', 5800, 1),
('Lucas Martínez', '1159876543', 'lucasm.art', 3800, 'Efectivo', '2025-07-04', 'Barrio Chino', '2025-07-06', '10:00:00', 0, 2),
('Martina López', '1145678901', NULL, 5600, 'Efectivo', '2025-07-05', 'Puerta del subte D', '2025-07-07', '17:15:00', 0, 3),
('Sofia Gómez', '1167890123', 'cami.gmz', 3700, 'Mercado Pago', '2025-07-06', 'Barrio Chino', '2025-07-08', '13:30:00', 0, 4),
('Agustina Pérez', '1176543210', 'agus.p', 4750, 'Transferencia', '2025-07-07', 'Barrio Chino', '2025-07-09', '12:00:00', 0, 5),
('Valentina Lee', '1189012345', 'valenlee', 3000, 'Mercado Pago', '2025-07-08', 'Av. Cabildo 65', '2025-07-10', '16:00:00', 4000, 6),
('Lucas Fernández', '1198765432', NULL, 4200, 'Tarjeta', '2025-07-09', 'Estación Central', '2025-07-11', '14:00:00', 3000, 7);